...
void ViewManager::Scrolling_Callback(GLFWwindow* window, double xOffset, double yOffset) //added for scrolling
{
	if (yOffset != 0) {
		g_pCamera->MovementSpeed += yOffset * 0.5f;
...
void ViewManager::PrepareSceneView()
{
    ...
    if (m_projectionType == ProjectionType::Perspective) {
        ...
        float orthoHeight = 10.0f;  // Define a suitable height for your scene scale
